...
create_db() {
	...
	dbca -silent -createDatabase -responseFile /assets/dbca.rsp
        cp /assets/listener.ora opt/oracle/app/product/11.2.0/dbhome_1/network/admin/
        cp /assets/tnsnames.ora opt/oracle/app/product/11.2.0/dbhome_1/network/admin/
